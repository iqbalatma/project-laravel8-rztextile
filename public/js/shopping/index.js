  ...
  $.ajax({
    ...
    if (response.status == 200) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
        ...
        window.open("report/invoices/stream/" + response.data.id, "_blank");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  onClickConfirm: function onClickConfirm() {
    ...
    var isCustomDate = $("#btn-check-custom-date").is(":checked");
    if (isCustomDate) {
      if ($("#custom-date").val() == "") {
        return sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire("Custom date is required");
      }

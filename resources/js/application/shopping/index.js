...
$(document).ready(function () {
    ...
    function setSelectedOptionToTableRow(dataSet) {
        ...
        tr.append(
            sellingPrice.getSellingPriceElement(parseInt(dataSet.selling_price))
        );

        tr.append(
            $(`<td>`, {
                text: helper.formatIntToRupiah(parseInt(dataSet.selling_price)),
